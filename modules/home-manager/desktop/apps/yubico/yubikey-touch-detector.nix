{ ... }:
{
  # All credit to: https://github.com/berbiche/dotfiles/blob/4048a1746ccfbf7b96fe734596981d2a1d857930/modules/home-manager/yubikey-touch-detector.nix
  # MIT License: https://github.com/berbiche/dotfiles/blob/4048a1746ccfbf7b96fe734596981d2a1d857930/LICENSE
  flake.modules.homeManager.apps =
    ...
    let
      cfg = config.myHome.desktop.apps.yubico.touchDetector;
    in
    with lib;
    {
      imports = [ ];
      options.myHome.desktop.apps.yubico.touchDetector = with lib; {
